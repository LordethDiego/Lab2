...
public class ArrayList<E> implements List<E> {
	...
	public static int totalCount(String s, List<String>[] arrayOfLists) {
		int result = 0;
		for (List<String> listOfStrings: arrayOfLists) {
	...
	public List<E> reverse() {
		int listSize = this.currentSize;
		List<E> result = new ArrayList<E>(listSize);
